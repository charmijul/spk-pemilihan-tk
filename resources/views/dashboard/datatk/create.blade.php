...
@section('container')
    ...
    <div class="col-lg-5">
        <form method="post" action="/dashboard/datatk" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" @error('longtitude') is-invalid @enderror
                                id="longtitude" name="longtitude" readonly required>
                            @error('longtitude')
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" @error('lattitude') is-invalid @enderror
                                id="lattitude" name="lattitude" readonly required>
                            @error('lattitude')
                                <div class="invalid-feedback">
                                    {{ 'Harap Memasukkan Titik Koordinat Lokasi TK' }}
                                </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('link_address') is-invalid @enderror" name="link_address"
                    id="link_address" value="{{ old('link_address') }}">
                    @error('spp')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('entry_fee') is-invalid @enderror" name="entry_fee"
                    id="entry_fee" required value="{{ old('entry_fee') }}">
                @error('entry_fee')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('capacity') is-invalid @enderror" name="capacity"
                    id="capacity" required value="{{ old('capacity') }}">
                @error('capacity')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('teachers') is-invalid @enderror" name="teachers"
                    id="teachers" required value="{{ old('teachers') }}">
                @error('teachers')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="accreditation" id="accreditation" required
                    value="{{ old('accreditation') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('facilities') is-invalid @enderror" name="facilities"
                    id="facilities" required value="{{ old('facilities') }}">
                @error('facilities')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
